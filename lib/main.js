...
const kSHARE_URLS = [
  ...
  "http://www.facebook.com/dialog/plugin.optin",
  "https://www.facebook.com/dialog/plugin.optin",
...
let NetworkListener = {
                                             ...
                                             aExtraStringData)
  {
    ...
    if (aActivitySubtype != this.activityTypes.ACTIVITY_SUBTYPE_RESPONSE_COMPLETE) {
      return;
    }
