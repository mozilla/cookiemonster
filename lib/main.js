...
function getBaseDomain(aURI) {
  ...
  try {
    ...
    log("eTLDService error getting tld from", aURI.host);
  }
  return etld;
}
...
function onCookieChanged(event) {
  console.log("on cookie changed", event.data);
